        ...
        <div className="max-w-sm mx-auto my-4">
            ...
            <div className="">
                <div>
                    ...
                    <p className="cardsTextColor mb-3"><span className="font-semibold">Veröffentlicht:</span> {new Date(props.Book.BookItem.publicationDate).toLocaleDateString("de-DE")}</p>
